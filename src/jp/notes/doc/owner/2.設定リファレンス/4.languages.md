...
language file to customize messages. The `cui` folder contains language files for the CUI interface. The names
of the interface language files match those in the `languages` folder.
