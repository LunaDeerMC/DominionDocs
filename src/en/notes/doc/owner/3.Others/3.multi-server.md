...
- Prepare a MySQL, MariaDB, or PgSql database;
...
new MySQL, MariaDB, or PgSql database and start the server once,
...
If your previous database was MySQL, MariaDB, or PgSql, you can directly refer to [Scenario Two](#Scenario-Two) for configuration
...
First, configure the database. You can choose to use MySQL, MariaDB, or PgSql, then configure the same database information
