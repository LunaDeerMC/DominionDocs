...
language file to customize command and notification messages. Chest UI text is configured separately under
`languages/chest-ui/texts`. See the [Chest UI reference](/en/notes/doc/owner/config-ref/chest-ui/).
