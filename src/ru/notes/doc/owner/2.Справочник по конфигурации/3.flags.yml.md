...
environment:
  ...
  fire_spread: # Распространение огня-Предотвращение распространения огня в доминионе.
    default: false
    enable: true
  burn_block: # Сгорание блоков-Могут ли блоки сгорать.
    default: false
    enable: true
  burn_entity: # Горение сущностей-Могут ли сущности гореть или получать урон от высокой температуры (кроме игроков).
    default: false
    enable: true
